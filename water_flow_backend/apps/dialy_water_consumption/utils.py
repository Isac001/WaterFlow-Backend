...
def daily_water_consumption():
    try:
        ...
        if DialyWaterConsumption.objects.filter(date_label__contains=f"Total de litros consumidos do dia {formatted_date}").exists():
        ...
        return DialyWaterConsumption.objects.create(
