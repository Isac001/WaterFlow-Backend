# Import Sum for database aggregation functions
...
import logging
# Import the FlowRating model from the flow_rating app
from apps.flow_rating.models import FlowRating
# Import the DailyWaterConsumption model from the daily_water_consumption app
...
def calculate_daily_water_consumption():
    ...
    try:
        ...
        records = FlowRating.objects.filter(
            # Filter records where the date part of times_tamp matches today
